...
SIMULACIÓN Y MONTAJE INICIAL DE CIRCUITO DE PIEZOELÉCTRICOS Y CIRCUITO ANALÓGICO
...
Figura 11. Datos en decimal mostrados en la pantalla de un celular.